...
if __name__ == '__main__':
    ...
    M_list = [10000]
    for M in M_list:
        fname="stav-"+str(M)+"-J0-"+str(J0)+"-h0-"+str(h0)+"-cd-sing-two-update-alpha-single-0317-2.dat"
        f=open(fname,"w")
        ...
        for N in N_list:
            ...
            while(m<M):
                ...
                if((1+xx+xax)!=0 and (1+xx-xax)!=0):
                    ...
                    m+=1
                #end if 
            bias_h_ml, b_std_h_ml = np.mean(bh_list_ml), np.std(bh_list_cd)/sqrtM
            bias_J_ml, b_std_J_ml = np.mean(bJ_list_ml), np.std(bJ_list_cd)/sqrtM
            ...
            f.write(str(N) 
                    + "  " + str(abs(bias_h_ml)) + "  "  + str(b_std_h_cd) 
                    ...
                    + "  " + str(abs(bias_h_cd_singHB)) + "  "  + str(b_std_h_cd_singHB) 
