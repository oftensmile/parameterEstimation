...
for t1 in range(theta_slice):
    for t2 in range(theta_slice):
        theta1=theta_min+t1*dtheta
        theta2=theta_min+t2*dtheta
        ...
        for nin in range(n_bach):
            ...
            for hd in range(d):
                ...
                diff_E1_nin=diff_delE1_nin*theta1
                diff_E2_nin=diff_delE2_nin*theta2
