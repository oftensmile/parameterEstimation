...
sample_list=[50,100,200,400,800]
beta_list=[0.01,0.1,1.0,10.0]
for beta in beta_list:
    name_result="result-Claster-N_sample"+str(N_sample)+"-beta"+str(beta)+ ".dat"
    ...
    for N_sample in sample_list:
        ...
        for t_gd in range(t_gd_max):
            ...
            f.write(str(N_sample)+" "+str(error_func)+"\n")
